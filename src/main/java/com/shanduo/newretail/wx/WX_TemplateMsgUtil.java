...
public class WX_TemplateMsgUtil {
     ...
     * @return 模板ID
     */
    public static String getWXTemplateMsgId(String accessToken,String templateSerialNumber){
        String tmpurl = "https://api.weixin.qq.com/cgi-bin/template/api_add_template?access_token="+accessToken;
        JSONObject json = new JSONObject();
     ...
     * @return
     */
    public static String deleteWXTemplateMsgById(String accessToken, String templateId){
        String tmpurl = "https://api.weixin.qq.com/cgi-bin/template/del_private_template?access_token="+accessToken;
        JSONObject json = new JSONObject();
     ...
     * @return
     */
    public static String sendWechatMsgToUser(String accessToken,String touser, String templatId, String clickurl, String topcolor, JSONObject data) {
